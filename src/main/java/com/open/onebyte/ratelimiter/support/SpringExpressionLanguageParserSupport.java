 ...
 * @author yangqk
 */
public class SpringExpressionLanguageParserSupport {

    private static final Logger log = LoggerFactory.getLogger(SpringExpressionLanguageParserSupport.class);
    ...
    private SpringExpressionLanguageParserSupport() {
    }
